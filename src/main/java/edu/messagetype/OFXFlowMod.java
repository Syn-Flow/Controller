...
public class OFXFlowMod extends OFMessage implements OFInstructionFactoryAware,
		Cloneable {
	...
	public static final byte OFPFC_MODIFY_STRICT = 2; /*
													 * Modify entry strictly
													 * matching wildcards
													 */
	public static final byte OFPFC_DELETE = 3; /* Delete all matching flows. */
	public static final byte OFPFC_DELETE_STRICT = 4; /*
													 * Strictly match wildcards
													 * and priority.
													 */
	 ...
	 * @param bufferId
	 */
	public OFXFlowMod setBufferId(int bufferId) {
	 ...
	 * @param cookie
	 */
	public OFXFlowMod setCookie(long cookie) {
		this.cookie = cookie;
		return this;
	}
	 ...
	 * @param cookieMask
	 */
	public OFXFlowMod setCookieMask(long cookieMask) {
	 ...
	 * @param tableId
	 */
	public OFXFlowMod setTableId(byte tableId) {
	 ...
	 * @param command
	 */
	public OFXFlowMod setCommand(byte command) {
	 ...
	 * @param flags
	 */
	public OFXFlowMod setFlags(short flags) {
		this.flags = flags;
		return this;
	}
	 ...
	 * @param hardTimeout
	 */
	public OFXFlowMod setHardTimeout(short hardTimeout) {
	 ...
	 * @param idleTimeout
	 */
	public OFXFlowMod setIdleTimeout(short idleTimeout) {
		this.idleTimeout = idleTimeout;
		return this;
	}

	/**
	 * Gets a copy of the OFMatch object for this OFX_FlowMod, changes to this
	 * object do not modify the OFX_FlowMod
	 * 
	 * @return
	 */
	 ...
	 * @param match
	 */
	public OFXFlowMod setMatch(OFMatch match) {
		this.match = match;
		return this;
	}
	 ...
	 * @param outPort
	 */
	public OFXFlowMod setOutPort(int outPort) {
	 ...
	 * @param port
	 */
	public OFXFlowMod setOutPort(OFPort port) {
	 ...
	 * @param outGroup
	 */
	public OFXFlowMod setOutGroup(int outGroup) {
	 ...
	 *            object
	 */
	public OFXFlowMod setOutGroup(OFGroup group) {
	 ...
	 * @param priority
	 */
	public OFXFlowMod setPriority(short priority) {
	 ...
	 */
	public OFXFlowMod setInstructions(List<OFInstruction> instructions) {
	...
	public void readFrom(ByteBuffer data) {
		...
		this.instructions = this.instructionFactory.parseInstructions(
				data,
				getLengthU() - MINIMUM_LENGTH + OFMatch.MINIMUM_LENGTH
						- match.getLength());
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof OFXFlowMod)) {
			return false;
		}
		OFXFlowMod other = (OFXFlowMod) obj;
		if (instructions == null) {
	 ...
	 */
	@Override
	public OFXFlowMod clone() {
		try {
			OFMatch neoMatch = match.clone();
			OFXFlowMod flowMod = (OFXFlowMod) super.clone();
	...
	public String toString() {
		return "OFX_FlowMod [instructions=" + instructions + ", bufferId="
				+ U32.f(bufferId) + ", tableId=" + tableId + ", command="
				+ command + ", cookie=" + cookie + ", cookieMask=" + cookieMask
