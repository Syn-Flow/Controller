...
//@lyk
import edu.action.OFXActionDecTTL;
import edu.action.OFXActionJump;
import edu.action.OFXActionPopActionPointer;
import edu.action.OFXActionPopShim;
import edu.action.OFXActionPushActionPointer;
import edu.action.OFXActionPushShim;
import edu.action.OFXActionSetTTL;
/**
...
public enum OFActionType {
   ...
   DEC_MPLS_TTL         (16, OFActionDecrementMPLSTTL.class, new Instantiable<OFAction>() {
    ...
    PUSH_SHIM           (30, OFXActionPushShim.class, new Instantiable<OFAction>() {
    						@Override
    						public OFAction instantiate() {
    							return new OFXActionPushShim();
    						}}),
    POP_SHIM            (31, OFXActionPopShim.class, new Instantiable<OFAction>() {
    						@Override
    						public OFAction instantiate() {
    							return new OFXActionPopShim();
    						}}),
    PUSH_AP				(32, OFXActionPushActionPointer.class, new Instantiable<OFAction>() {
    						@Override
    						public OFAction instantiate() {
    							return new OFXActionPushActionPointer();
    						}}),
    POP_AP				(33, OFXActionPopActionPointer.class, new Instantiable<OFAction>() {
    						@Override
    						public OFAction instantiate() {
    							return new OFXActionPopActionPointer();
    						}}),
    SET_F3_TTL			(34, OFXActionSetTTL.class, new Instantiable<OFAction>() {
    						@Override
    						public OFAction instantiate() {
    							return new OFXActionSetTTL();
    						}}),
    DEC_F3_TTL			(35, OFXActionDecTTL.class, new Instantiable<OFAction>() {
    						@Override
    						public OFAction instantiate() {
    							return new OFXActionDecTTL();
    						}}),
    JUMP				(36, OFXActionJump.class, new Instantiable<OFAction>() {
    						@Override
    						public OFAction instantiate() {
    							return new OFXActionJump();
    						}}),
