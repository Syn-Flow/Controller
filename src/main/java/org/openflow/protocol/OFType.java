 ...
 */
    ...
    OFX_FLOW_MOD         (66, OFXFlowMod.class, new Instantiable<OFMessage>() {
                            @Override
                            public OFMessage instantiate() {
                                return new OFXFlowMod();
                            }}),
    OFX_PACKET_OUT       (67, OFXPacketOut.class, new Instantiable<OFMessage>() {
                            @Override
                            public OFMessage instantiate() {
                                return new OFXPacketOut();
                            }}),
    OFX_FLOW_MOD_REPLY	 (31, OFXFlowModReply.class, new Instantiable<OFMessage>() {
    						@Override
    						public OFMessage instantiate() {
    							return new OFXFlowModReply();
    						}}),
    OFX_PORT_MOD_REPLY	 (32, OFXPortModReply.class, new Instantiable<OFMessage>() {
    					    @Override
    					    public OFMessage instantiate() {
    					    	return new OFXPortModReply();
    					    }}),
    OFX_TABLE_FEATURE    (33, OFXTableFeature.class, new Instantiable<OFMessage>() {
    						@Override
    						public OFMessage instantiate() {
    							return new OFXTableFeature();
    						}});
