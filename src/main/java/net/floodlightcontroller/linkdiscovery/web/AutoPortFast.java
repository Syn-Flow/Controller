...
/**
 * @author Yikai Lin (hilarious0401@gmail.com)
 *
 */
public class AutoPortFast extends ServerResource {
	...
	public String retrieve() {
		F3LinkDiscoveryService linkDiscovery;
		linkDiscovery = (F3LinkDiscoveryService) getContext().getAttributes()
				.get(F3LinkDiscoveryService.class.getCanonicalName());

		String param = ((String) getRequestAttributes().get("state"))
				.toLowerCase();
